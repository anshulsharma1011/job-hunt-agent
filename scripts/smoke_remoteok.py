"""
Smoke test for RemoteOKSource — real HTTP, no credentials needed.

Usage:
    python scripts/smoke_remoteok.py
"""
import sys
...
def main() -> None:
    config = load_config()
    source = RemoteOKSource(config)

    print(f"Querying RemoteOK for {len(CRITERIA.titles)} job titles...\n")
